...
const string questionsOAIP[15] = {
    ...
    "13) В чем принципиальное отличие компилятора от интерперетатора?  \n\
    1.	 Компилятор генерирует загрузочный модуль, интерпретатор переводит исходный код в код, близкий к машинному. \n\
    2.	 Компилятор переводит исходный код сразу в машинный, интерпретатор переводит исходный код в код, близкий к машинному \n\
    3.	 Компилятор переводит исходный код в код, близкий к машинному, интерпретатор переводит исходный код сразу в машинный \n\
    4.	 Нет отличий \n",
